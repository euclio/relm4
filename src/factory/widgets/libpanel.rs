...
impl<Widget> FactoryView<Widget> for libpanel::Paned where Widget: glib::IsA<gtk::Widget> {
    type Position = ();
    type Root = Widget;
...
impl<Widget> FactoryListView<Widget> for libpanel::Paned where Widget: glib::IsA<gtk::Widget> {
